...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_OverlapComponent = { UE4CodeGen_Private::EPropertyClass::Object, "OverlapComponent", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000080080, 1, nullptr, STRUCT_OFFSET(FPSExtractionZone_eventHandleOverlap_Parms, OverlapComponent), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(NewProp_OverlapComponent_MetaData, ARRAY_COUNT(NewProp_OverlapComponent_MetaData)) };
	...
	UClass* Z_Construct_UClass_AFPSExtractionZone()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSExtractionZone_HandleOverlap, "HandleOverlap" }, // 3880609282
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSExtractionZone, 3674319181);
